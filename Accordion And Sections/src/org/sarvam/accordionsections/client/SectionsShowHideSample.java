...
public class SectionsShowHideSample {
	public HLayout getSectionShowHide(){
		 HTMLFlow htmlFlow = new HTMLFlow();  
	        ...
	        section3.addItem(new Img("/images/car.jpg", 48, 48));  
	        ...
	        section4.addItem(new Img("/images/ducati.jpg", 48, 48));  
