...
public class SectionsReorderSample {
	public SectionStack getSectionReorder(){
		 HTMLFlow htmlFlow = new HTMLFlow();  
	        ...
	        section1.addItem(new Img("/images/car.jpg", 48, 48));  
